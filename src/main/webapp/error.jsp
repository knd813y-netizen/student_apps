			...
			<c:if test="${user.isAuthenticated()}">
				<div class="nav align-self-end">
					...
					<a class="nav-item px-2"
					   href="/JavaSystemDev/scoremanager/main/Logout.action">
					   	ログアウト
					</a>
				</div>
			</c:if>
					...
					<nav class="col-3">
						...
						<ul class="nav nav-pills flex-column mb-auto px-4">
							<li class="nav-item my-3">
								<a href="/JavaSystemDev/scoremanager/main/Menu.action">
									メニュー
								</a>
							</li>
							<li class="nav-item mb-3">
								<a href="/JavaSystemDev/scoremanager/main/StudentList.action">
									学生管理
								</a>
							</li>
							<li class="nav-item">
							...
							<li class="nav-item mx-3 mb-3">
								<a href="/JavaSystemDev/scoremanager/main/TestRegist.action">
									成績登録
								</a>
							</li>
							<li class="nav-item mx-3 mb-3">
								<a href="/JavaSystemDev/scoremanager/main/TestList.action">
									成績参照
								</a>
							</li>
							<li class="nav-item mb-3">
								<a href="/JavaSystemDev/scoremanager/main/SubjectList.action">
									科目管理
								</a>
							</li>
							<li class="nav-item mb-3">
								<a href="/JavaSystemDev/scoremanager/main/ClassList.action">
									クラス管理
								</a>
							</li>
						</ul>
